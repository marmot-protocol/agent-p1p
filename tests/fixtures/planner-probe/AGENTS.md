...
differs from runtime evidence. Write plan artifacts and plan-v1.json in the
task's storage.results directory, leaving tracked source and evidence unchanged.
