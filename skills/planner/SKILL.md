...
10. Return the Rust `planner` result contract from `docs/worker-result-contracts.md`. Use `plan_artifact`; do not emit GitHub comment fields, legacy `case_id`, `schema_version`, `plan_file`, or ISO timestamp fields.
